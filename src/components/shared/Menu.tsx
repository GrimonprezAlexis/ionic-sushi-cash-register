...
const MenuComponent: React.FC = () => {
    ...
    return (
        <IonMenu ref={menuRef} side="start" type={menuType} contentId="main-content">
        <IonHeader>
            <IonToolbar>
                <IonItem color="medium">
                    <IonAvatar slot="start">
                        <img src="https://avatars.githubusercontent.com/u/78658625?v=4" alt=""/>
                    </IonAvatar>
        ...
        <IonContent>
            <IonList>
                ...
                <IonItem button onClick={() => navigateTo('/list-command')}>
                    <IonIcon aria-hidden="true" icon={apps} slot="start"></IonIcon>
                    <IonRouterLink routerLink="/list-command" color="default">
